...
@FunctionalInterface
public interface AsyncSinkFunction<M>  extends InitableFunction, ClosableFunction, Serializable {
   ...
   */
  CompletableFuture<Void> apply(M message, MessageCollector messageCollector, TaskCoordinator taskCoordinator);
}
